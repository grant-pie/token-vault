...
- **`js/app.js`** — renders the token grid, live search-as-you-type filtering, and pagination. Clicking a token card opens the customizer modal (below) instead of downloading directly.
