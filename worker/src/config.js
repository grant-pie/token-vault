...
[[shadow]]The one exception to the rules above: add a soft circular [shadow color] drop shadow directly beneath the creature, to improve readability on busy battlemaps. Keep the shadow visually separate from the creature's painterly rendering: it must read as a simple, clean, soft-edged ellipse — low-detail and visually uniform, translucent, and heavily feathered, darkest directly beneath the feet and fading smoothly toward its outer edge, with no brush texture, paint strokes, terrain texture, cracks, footprints, or surface detail. It must not resemble a painted platform, a patch of soil, a pool of paint, a textured floor, or a solid base. The shadow should be approximately 15% larger than the creature's footprint, medium opacity (35–45%), and remain entirely beneath the creature without wrapping around the body. This drop shadow is deliberate token artwork, required in the final image — not scenery to be cut away with the rest of the background.[[/shadow]]
