...
Camera Angle: High-angle top-down three-quarter view (approximately 60° downward), looking down from above but still showing the creature's face, chest, shoulders, and upper body. The camera should not be a true 90° overhead orthographic view, and should read as a comfortably distant illustrator's vantage point rather than a close-up tactical sprite shot — favor a slightly further-back framing over a tightly zoomed one. Use convincing, controlled top-down foreshortening rather than a flattened or purely orthographic look — the perspective should reinforce the pose and silhouette without distorting the anatomy into a wide-angle or fisheye appearance.
